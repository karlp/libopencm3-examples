...
int main(void)
{
	...
	gpio_set_mode(LED_RX_PORT, GPIO_MODE_OUTPUT_2_MHZ,
                GPIO_CNF_OUTPUT_PUSHPULL, LED_RX_PIN);
	gpio_set_mode(LED_TX_PORT, GPIO_MODE_OUTPUT_2_MHZ,
                GPIO_CNF_OUTPUT_PUSHPULL, LED_TX_PIN);
	...
	usb_cdcacm_init(&usbd_dev, driver);
